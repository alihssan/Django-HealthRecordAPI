    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specialization', models.CharField(blank=True, help_text="Doctor's specialization (e.g., Cardiology, Pediatrics)", max_length=100, null=True)),
                ('available_days', models.JSONField(blank=True, help_text='List of available days with time slots', null=True)),
                ('appointment_duration', models.IntegerField(blank=True, help_text='Default appointment duration in minutes', null=True)),
                ('max_patients_per_day', models.IntegerField(blank=True, help_text='Maximum number of patients per day', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notification_type', models.CharField(choices=[('PATIENT_ASSIGNED', 'New Patient Assigned'), ('ANNOTATION_ADDED', 'Annotation Added')], max_length=20)),
